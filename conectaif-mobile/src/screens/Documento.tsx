...
const styles = StyleSheet.create({
  ...
  searchInput: { padding: 10, borderColor: '#ccc', borderWidth: 1, borderRadius: 8, marginBottom: 10 },
  documentItem: { marginVertical: 10, padding: 15, backgroundColor: '#f2f2f2', borderRadius: 8 }
});
